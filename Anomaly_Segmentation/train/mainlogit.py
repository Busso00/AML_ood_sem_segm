...
def train(args, model, enc=False):
    ...
    if args.model == "erfnet":
      ...
      criterion = LogitNormLoss(device=args.cuda, t = 1, weight=weight)
      optimizer = Adam(model.parameters(), 5e-4, (0.9, 0.999),  eps=1e-08, weight_decay=1e-6) #5e-4
      lambda1 = lambda epoch: pow((1-((epoch-1)/args.num_epochs)), 0.9)  #3
